...
descKo: |-
  ...
  • <strong>광이 아니라 '속광':</strong> 글리터 없이 피부 자체가 좋아 보이는 투명한 광채를 만듭니다.
  • <strong>피부 온도에 멜팅:</strong> 바르는 순간 부드럽게 녹아 경계 없이 스며듭니다.
  • <strong>어떤 조명에서도:</strong> 백스테이지 조명뿐 아니라 일상의 자연광에서도 자연스럽습니다.
  • <strong>추천 색상:</strong> 처음이라면 가장 자연스러운 트랜스페어런트 또는 스컬팅.

  <strong>검증 포인트:</strong> 펄/글리터 들뜸 현상 배제, 자연광 및 조명 아래 밀착력 테스트
---
