...
문구 구성 (2026-08-25 Paula 지시로 개편): **제목(첫 줄 — 계정 이름 옆에 링크가 붙지 않게)** →
**구매 링크 + "#ad #광고"**(짧은 광고 표시는 접히기 전 영역에 필수: FTC 규정 + 아마존 제휴 약관)
→ 한국어 소개 → 영어 소개 → sift41.com 안내 → 분류별 해시태그 30개 → **구매 링크(맨 뒤 한 번 더)**
→ 긴 광고 표시("광고 · 제휴 링크 포함 | Ad · affiliate links")는 **맨 밑**.
구매 링크 두 군데는 2026-08-21 Paula 지시. 2,200자 초과 시 영어 소개를 뺀다 (구매 링크·해시태그는 유지).
광고 표시를 완전히 없애는 것은 금지 — 제휴 계정 정지 사유가 될 수 있다 (Paula에게 2026-08-25 설명함).
